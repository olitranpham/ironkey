  ...
  return (
    <div className="min-h-screen bg-[#292929] flex flex-col items-center py-12 px-4">
      ...
      <div className="w-full max-w-2xl flex flex-col gap-4">
        ...
        <p className="text-center text-[11px] text-neutral-700 mt-1">© 2026 · powered by <a href="https://ironkeyentry.com" target="_blank" rel="noopener noreferrer" className="underline"><strong>ironkey llc</strong></a></p>
      </div>
    </div>
  )
}
