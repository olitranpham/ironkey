...
export default function GuestPage() {
  ...
  return (
    <div className="min-h-screen bg-[#292929] flex flex-col items-center py-12 px-4">
      ...
      <p className="text-center text-[11px] text-neutral-700 mt-6">powered by <a href="https://ironkeyentry.com" target="_blank" rel="noopener noreferrer" className="underline"><strong>ironkey llc</strong></a> · © 2026 · secured by <strong>Stripe</strong></p>
